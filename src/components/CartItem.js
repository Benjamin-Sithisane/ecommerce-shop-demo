...
const CartItem = ({item}) => {
  ...
  return (
    ...
    border-gray-200 w-full font-light text-gray-500'>
      <div className='w-full min-h-0-[150px] flex items-center 
      gap-x-4'>
          <Link to={`/product/${id}`}>
            <img className='max-w-[80px]' src={image} alt='' />
              ...
              <div className='w-full flex flex-col'>
                  <div className='flex justify-between mb-2'>
                    <Link 
                      to={`/product/${id}`} className='text-sm uppercase font-medium max-w-
                  ...
                  text-sm'>
                      ...
                      text-primary font-medium'>
                        <div onClick={() => decreaseQuantity(id)} className='flex-1 flex justify-center 
                        ...
                        <div onClick={() => increaseQuantity(id)} className='flex-1 h-full flex 
